...
{
	if (A.m_health > (int)B.m_attack)
		A.m_health -= (int)B.m_attack;
	else
		A.m_health = 0;

	if (B.m_health > (int)A.m_attack)
		B.m_health -= (int)A.m_attack;
	else
		B.m_health = 0;
}
...
{
	if (A.m_health > (int)(B.m_superPowerAttack - A.m_superPowerDefend))
		A.m_health -= (int)(B.m_superPowerAttack - A.m_superPowerDefend);
	else
		A.m_health = 0;

	if (B.m_health > (int)(A.m_superPowerAttack - B.m_superPowerDefend))
		B.m_health -= (int)(A.m_superPowerAttack - B.m_superPowerDefend);
	else
		B.m_health = 0;
}
